...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  func @main_graph(%arg0: tensor<1x1x28x28xf32>) -> tensor<1x1x19x19xf32> attributes {input_names = ["0"], output_names = ["2"]} {
    ...
    //CHECK: torch.aten.max_pool2d %arg0, %{{[^,]*}}, [[STRIDE]], [[PAD]], [[DILATION]], %false : !torch.vtensor<[1,1,28,28],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool -> !torch.vtensor<[1,1,13,13],f32>
